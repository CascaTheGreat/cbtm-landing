  ...
  return (
    <Container className="pt-32 pb-16 lg:pt-40 lg:pb-24">
      <div className="max-w-3xl">
        ...
        <br />
        <p>
          These terms and conditions apply to the CBTM app for mobile devices,
          together with any related services operated by Joshua Ledlow
          (collectively, the "Application"). Joshua Ledlow is hereby referred to
        ...
        <p>
          ...
          13 years of age (the age of digital consent in your jurisdiction) to
          use the Application. If you are below 13, a parent or legal guardian
        ...
        <div>
          ...
          <p>
            ...
            the Application, or the Service Provider's trademarks is strictly
        ...
        <p>
          ...
          help@cbtm.app. The report should include enough information for the
          Service Provider to identify the content, evaluate the complaint, and
          contact you if follow-up is required.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          help@cbtm.app to request further review. The Service Provider will
          respond to appeals within a reasonable period and provide the reasons
          for any upheld moderation decision, subject to applicable law.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          related to User-Generated Content is governed by the Privacy Policy.
        ...
        <p>
          ...
          particular operating system version installed on your device. You
          should accept updates when offered; if you choose not to, the Service
          Provider may cease to support earlier versions and the Application may
          not function properly. The Service Provider may also wish to cease
        ...
        <br />
        <strong>DSA Compliance (Digital Services Act)</strong>
        <br />
        <p>
        ...
        <p>
          ...
          and recipients of the service, reachable at help@cbtm.app. Where the
          Service Provider is established outside the European Union, a legal
          representative in the EU has been designated in accordance with
        ...
        <p>
          ...
          Reports are made available upon request at help@cbtm.app.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          constitute the entire agreement between you and the Service Provider
          concerning your use of the Application, superseding any prior
        ...
        <br />
        <p>These terms and conditions are effective as of 2026-06-28</p>
        <br />
