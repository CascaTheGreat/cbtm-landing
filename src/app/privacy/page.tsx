  ...
  return (
    <Container className="pt-32 pb-16 lg:pt-40 lg:pb-24">
      <div className="max-w-3xl">
        ...
        <p>
          This privacy policy applies to the CBTM app for mobile devices,
        ...
        <div>
          ...
          <p>
            ...
            location-based features, improve the Application, and support
            related services.
          </p>
          <ul>
            <li>
              Geolocation Services: The Service Provider may use location data
              to provide location-based features or content.
            </li>
            <li>
              Analytics and Improvements: Aggregated location data may help the
              Service Provider understand usage patterns and improve
              performance.
            </li>
            <li>
              Third-Party Services: Location data may be shared with third-party
              services used to support Application functionality, subject to
        ...
        <p>
          ...
          Service Provider at help@cbtm.app.
        </p>
        <br />
        ...
        <p>
          ...
          information, including but not limited to Email, location, IP address.
          The information the Service Provider requests will be retained and
        ...
        <ul>
          ...
          <li>
            ...
            not have an independent use of the information the Service Provider
            discloses to them, and have agreed to adhere to the rules set forth
        ...
        <p>
          ...
          them at help@cbtm.app. Please note that some User Provided Data may be
        ...
        <div>
          ...
          <p>
            ...
            information from children under 13 years of age in violation of
            ...
            Provider (help@cbtm.app) so that they will be able to take the
            necessary actions.
          </p>
        </div>
        <br />
        ...
        <p>
          ...
          the updated Privacy Policy with an effective date. Where required by
          law, the Service Provider will seek your consent to material changes
        ...
        <p>
          ...
          Service Provider via email at help@cbtm.app.
        </p>
        <hr />
        <p>
